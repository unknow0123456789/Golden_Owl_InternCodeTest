...
import 'package:flutter_test_goldenowl/our_product.dart';

late final List<Product> fixlist;
final String listkey="goldenowlsavedlist";
void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  final prefs = await SharedPreferences.getInstance();
  String? SavedList=prefs.getString(listkey);
  if(SavedList!=null)
    fixlist=Product.decode(SavedList);
  else fixlist=FixDataSet_Product();
  runApp(const MyApp());
}
...
List<Product> FixDataSet_Product()
{
